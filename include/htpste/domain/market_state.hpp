...
public:
    ...
    [[nodiscard]] std::optional<double> priceFor(std::string_view symbol) const noexcept;
    [[nodiscard]] std::optional<double> parameter(std::string_view name) const noexcept;
